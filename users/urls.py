...
urlpatterns = [
    ...
    path('user/<int:pk>/update', customer_views.UserUpdateView.as_view(), name='user_update'),
    path('customer/<int:pk>/', customer_views.CustomerDetailView.as_view(), name='customer_detail'),
    path('customer/<int:pk>/update', customer_views.CustomerUpdateView.as_view(), name='customer_update'),
